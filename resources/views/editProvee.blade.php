...
@section('contenido')
@section('TituloPlantillas', 'Editar proveedores')
                ...
                <div class="card-body">
                    ...
                    <form style="margin-left: 2%;" method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <input class="form-control " type="text" class="form-control-file" name="nombrepro" id="nombrepro" placeholder="Nombre_del_proveedor" value="{{$proveedor->Nombre_del_proveedor}}" maxlength="50">
                        </div>
