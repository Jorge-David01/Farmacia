            ...
            <div class="col-12 col-lg-12">
                <div class="card">
                    ...
                    <div style="width: 100%;  margin-right: 1%">
                        <div style="margin-left: 1% ;  margin-bottom: 2%; width: 100%; ">
                            <form method="post">
                                @csrf
                                ...
                                <div style="width: 98%; float: left;margin-top: 2%; margin-bottom: 1%; margin-right: 2%">
                        ...
                        <div style="margin-left: 1% ;  margin-bottom: 2%; margin-right: 1%">
