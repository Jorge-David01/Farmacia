...
@section('contenido')
@section('TituloPlantillas', 'Cotización')
                                ...
                                <div class="card">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table align-items-center table-flush table-borderless">
                                            ...
                                            <tr>
                                                <td>
                                                    <form method="post" action="{{route('cotizacion.eliminar',['id'=>$p->id,'cliente'=>$idcliente])}}">
                                                        @csrf
                                                        @method('delete')
                                                        <center>
                                                ...
                                                <td style="text-align: left;">
                                                    ...
                                                    <form method="post" style="display: none" id="oculto{{$p->id}}" action="{{route('cotizacion.editar',['id'=>$p->id,'cliente'=>$idcliente])}}">
                                                        @csrf
                                                        @method('post')
