...
<h3>Cliente: {{$cotizacion->clientes->nombre_cliente}}&nbsp&nbsp&nbsp&nbspIdentidad: {{$cotizacion->clientes->numero_id}}</h3>

</center>

<a type="buttom" style="width: 100px;margin-left: 10px;margin-bottom: 10px;" href="{{route('cotizacion.create')}}" target="_blank" class="btn btn-info">Regresar</a>
...
<table class="table">
    ...
    <tbody>
        @foreach($cotizacion->detalles as $key => $detall)
<tr>
    <td>{{$key+1}}</td>
...
<tr>
    ...
    <?php $sum = 0?>
    @foreach($cotizacion->detalles as $detall)
    <?php $sum = $sum+($detall->precio*$detall->cantidad)*(1-$detall->descuento/100)?>
    @endforeach
    ...
    <tbody><div style="display: none;" id="printer">
<script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
<script src="https://cdn.jsdelivr.net/npm/popper.js@1.12.9/dist/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
