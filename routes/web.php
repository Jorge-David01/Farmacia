...
Route::get('/Detallesproduct/{id}',[ProductoController::class, 'detalles'])->name('detalles.producto')->where('id', '[0-9]+');
...
Route::get('/detallescompra/{id}',[CompraController::class, 'detailscompra']) -> name('details.compra')-> where('id', '[0-9]+');
