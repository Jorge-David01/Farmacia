...
//--------------------- EDITAR EMPLEADO -------------------------
    ...
    public function update(Request $request, $id){
       ...
       $rules=[
            ...
            'numero_cel'=> 'required|numeric|regex:([9,8,3]{1}[0-9]{7})|unique:empleados,numero_cel,'.$id,
            'numero_tel'=> 'required|numeric|regex:([2]{1}[0-9]{7})|unique:empleados,numero_tel,'.$id,
            'direccion'=>'required|max:100',
